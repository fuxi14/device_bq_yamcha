...
$(call inherit-product-if-exists, vendor/bq/yamcha/yamcha-vendor.mk)

# Init
PRODUCT_PACKAGES += \
    init.target.rc

# The following is what rests from device.mk from android_device_bq_chaozu on lineage OS
